...
class Main(Gtk.Window):
    def __init__(self):
        super(Main, self).__init__(title="DarkOs Tweaks")
        self.set_border_width(10)
        self.connect("delete-event", self.on_close)
        self.set_position(Gtk.WindowPosition.CENTER)
        self.set_icon_from_file(os.path.join(base_dir, 'images/darkos-logo.png'))
        ...
        if not Functions.os.path.isdir(Functions.home +
                                       "/.config/darkos-tweaks"):

            Functions.os.makedirs(Functions.home +
                                  "/.config/darkos-tweaks", 0o766)
            Functions.permissions(Functions.home +
                                  "/.config/darkos-tweaks")
        # Force Permissions
        a1 = Functions.os.stat(Functions.home + "/.config/autostart")
        a2 = Functions.os.stat(Functions.home + "/.config/darkos-tweaks")
        ...
        if att == 0:
            Functions.permissions(Functions.home + "/.config/darkos-tweaks")
            print("Fix Tweaks permissions...")
        if backup == 0:
...
#       #========================ARCO REPO SET TOGGLE=====================
        ...
        darkos_repo = pmf.check_repo("[DarkOs-Repo]")
#       #========================DarkOs cREPO=====================
        self.dark_repo_button.set_active(darkos_repo)
#       #========================ARCO REPO SET TOGGLE=====================
...
# =====================================================
    ...
    def on_pacman_dark_repo_toggle(self,widget,active):
        if not pmf.repo_exist('[DarkOs-Repo]'):
            pmf.append_repo(self,Functions.darkos_repo)
        else:
            if self.opened is False:
                pmf.toggle_test_repos(self,widget.get_active(),"darkos-repo")
...
#    #====================================================================
    ...
    def install_term_themes(self):
        ...
        GLib.idle_add(self.ls2.set_markup, "Please restart the <b>DarkOs Tweaks</b>")
...
if __name__ == "__main__":
    ...
    if not os.path.isfile("/tmp/att.lock"):
        ...
        md.format_secondary_markup(
            "The lock file has been found. This indicates there is already an instance of <b>DarkOs Tweaks</b> running.\n\
